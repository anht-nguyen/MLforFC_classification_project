...
tmux send-keys "sh ./autorun_MLP_model_singleFC.zsh && sh ./autorun_GCN_model_singleFC.zsh" C-m

# In the second pane, run CNN models and then run ML models training and validating script
tmux select-pane -t 1
tmux send-keys "sh ./autorun_CNN_model_singleFC.zsh && python ML_models_training_validating.py" C-m
