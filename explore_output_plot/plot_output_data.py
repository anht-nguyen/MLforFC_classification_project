...
def main():
    ...
    json_files = [
        "output_data-2025-GCN.json",
        "output_data-2025-CNN.json",
        "output_data-2025-MLP.json",
        "output_data-2025-SK.json"
    ]

    combined_data = load_json_files(json_files, script_dir)
